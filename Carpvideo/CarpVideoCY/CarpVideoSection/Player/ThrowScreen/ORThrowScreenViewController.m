...
- (void)setupUI
{
    ...
    UILabel *recommendLabel = [UILabel ly_LabelWithTitle:@"推荐" font:zy_blodFontSize10 titleColor:RGBA_HexCOLOR(0xFF6600, 1.0)];
    recommendLabel.layer.cornerRadius = 2.5f;
    recommendLabel.layer.borderColor = RGBA_HexCOLOR(0xFF6600, 1.0).CGColor;
...
- (void)dlnaStartPlay
{
    ...
    [SVProgressHUD showWithStatus:[NSString stringWithFormat:@"连接 %@",deviceName]];
...
- (void)dlnaErrorPlay
{
    [SVProgressHUD showWithStatus:@"投屏失败，请检查设备连接方式"];
}
