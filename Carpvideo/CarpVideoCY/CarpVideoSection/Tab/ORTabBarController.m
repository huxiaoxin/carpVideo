...
- (void)refreshTabBarViewController
{
    ...
    // 首页
    CarpVideoHomeViewController *indexVC = [[CarpVideoHomeViewController alloc] init];
    UINavigationController *indexNVC = [self produceRootNavigationControllerWithVC:indexVC title:@"首页" normalAttributes:@{NSForegroundColorAttributeName:LGDGaryColor} selectAttributes:@{NSForegroundColorAttributeName:LGDMianColor} normalImage:[UIImage imageNamed:@"carpVideo_home_nomal"] selectImage:[UIImage imageNamed:@"carpVideo_home_seltecd"]];
