...
- (void)setupUI
{
    UIButton *searchBtn = [UIButton ly_ButtonWithNormalImageName:@"carpVideo_sousuo_icon" selecteImageName:@"carpVideo_sousuo_icon" target:self selector:@selector(searchAction:)];
    ...
    [topButton setImage:[UIImage imageNamed:@"carpVideo_down_arrow_icon"] forState:UIControlStateNormal];
