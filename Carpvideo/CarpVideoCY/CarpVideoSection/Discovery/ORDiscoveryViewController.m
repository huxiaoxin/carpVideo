...
- (void)setupUI
{
    ...
    UIButton *topButton = [UIButton ly_ButtonWithTitle:@"综合排序" titleColor:gnh_color_theme font:zy_blodFontSize15 target:self selector:@selector(showFilterView:)];
...
- (void)refreshHeaderData
{
    ...
    if (self.discoveryMenuDataModel.discoveryMenuItem.channelTypes.count) {
        ...
        [self.discoveryMenuDataModel.discoveryMenuItem.channelTypes enumerateObjectsUsingBlock:^(__kindof ORDiscoveryTypeItem * _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
            ...
            if (idx == 0) {
                ...
                self.typeSelectedButton.backgroundColor = gnh_color_q;
                [self.typeSelectedButton setTitleColor:gnh_color_theme forState:UIControlStateNormal];
    ...
    UIButton *areaButton = [UIButton ly_ButtonWithTitle:@"全部" titleColor:gnh_color_theme font:zy_mediumSystemFont13 target:self selector:@selector(buttonAction:)];
    if (self.discoveryMenuDataModel.discoveryMenuItem.areaTypes.count) {
        areaButton.tag = 1;
        areaButton.backgroundColor = gnh_color_q;
    ...
    UIButton *yearButton = [UIButton ly_ButtonWithTitle:@"全部" titleColor:gnh_color_theme font:zy_mediumSystemFont13 target:self selector:@selector(buttonAction:)];
    if (self.discoveryMenuDataModel.discoveryMenuItem.yearTypes.count) {
        // 年份
        yearButton.tag = 2;
        yearButton.backgroundColor = gnh_color_q;
    ...
    UIButton *childtypeButton = [UIButton ly_ButtonWithTitle:@"全部" titleColor:gnh_color_theme font:zy_mediumSystemFont13 target:self selector:@selector(buttonAction:)];
    if (self.discoveryMenuDataModel.discoveryMenuItem.types.count) {
        // 类型
        childtypeButton.tag = 3;
        childtypeButton.backgroundColor = gnh_color_q;
...
- (void)buttonAction:(UIButton *)btn
{
    ...
    if (btn.tag == 1) {
        ...
        self.areaButton.backgroundColor = gnh_color_q;
        [self.areaButton setTitleColor:gnh_color_theme forState:UIControlStateNormal];
        ...
        self.yearButton.backgroundColor = gnh_color_q;
        [self.yearButton setTitleColor:gnh_color_theme forState:UIControlStateNormal];
        ...
        self.childtypeButton.backgroundColor = gnh_color_q;
        [self.childtypeButton setTitleColor:gnh_color_theme forState:UIControlStateNormal];
...
- (void)tagButtonAction:(UIButton *)btn
{
    ...
    if (btn.tag >= 100 && btn.tag < 200 ) {
        ...
        [self.areaSelectedButton setTitleColor:gnh_color_r forState:UIControlStateNormal];
        self.areaSelectedButton = btn;
        self.areaSelectedButton.backgroundColor = gnh_color_q;
        [self.areaSelectedButton setTitleColor:gnh_color_theme forState:UIControlStateNormal];
        ...
        [self.yearSelectedButton setTitleColor:gnh_color_r forState:UIControlStateNormal];
        self.yearSelectedButton = btn;
        self.yearSelectedButton.backgroundColor = gnh_color_q;
        [self.yearSelectedButton setTitleColor:gnh_color_theme forState:UIControlStateNormal];
        ...
        [self.childtypeSelectedButton setTitleColor:gnh_color_r forState:UIControlStateNormal];
        self.childtypeSelectedButton = btn;
        self.childtypeSelectedButton.backgroundColor = gnh_color_q;
        [self.childtypeSelectedButton setTitleColor:gnh_color_theme forState:UIControlStateNormal];
