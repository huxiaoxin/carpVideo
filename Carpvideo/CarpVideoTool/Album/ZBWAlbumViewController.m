...
- (UICollectionView *)albumCollectionView {
    if (_albumCollectionView == nil) {
        ...
        _albumCollectionView = [[UICollectionView alloc]initWithFrame:CGRectMake(0, GK_STATUSBAR_NAVBAR_HEIGHT, kScreenWidth, kScreenHeight-GK_STATUSBAR_NAVBAR_HEIGHT) collectionViewLayout:flowLayout];
