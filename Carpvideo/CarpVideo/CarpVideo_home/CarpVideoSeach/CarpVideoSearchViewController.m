...
@interface CarpVideoSearchViewController ()<CarpVideoAdViceTableViewCellDelegate>
@property(nonatomic,strong) NSMutableArray * dataArr;
@end

@implementation CarpVideoSearchViewController
...
-(void)CarpVieoAdviceHeaderClicks{
    MJWeakSelf;
    NSArray * dataArr = [WHC_ModelSqlite query:[CarpVideoHomeModels class] where:[NSString stringWithFormat:@"caprVideHome_ID ='%ld'",self.CarpSearID]];
