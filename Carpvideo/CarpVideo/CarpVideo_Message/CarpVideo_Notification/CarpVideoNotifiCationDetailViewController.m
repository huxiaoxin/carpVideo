...
- (void)viewDidLoad {
    ...
    CarpVideoTopTitle.text=  @"关于5月3号鲤鱼视频维护公告";
    [self.view addSubview:CarpVideoTopTitle];
    
    CGRect CarpVideoDetailRect = [@"尊敬的用户，您好～！\n因服务器升级需要，鲤鱼视频将于2021年6月25号服务器停机进行升级，届时app将无法访问大概有半个小时左右，还请大家稍安伪造等待一下，感谢各位的配合与支持，谢谢～" cxl_sizeWithMoreString:[UIFont systemFontOfSize:14] maxWidth:SCREEN_Width-K(20)];
